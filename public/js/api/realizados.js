...
if (typeof window !== "undefined") {
  window.FACT_REALIZADOS = FACT_REALIZADOS;
}

/* ===== Função para normalizar linhas de realizados ===== */
...
/* ===== Função para processar dados de realizados ===== */
function processRealizadosData(realizadosRaw = []) {
